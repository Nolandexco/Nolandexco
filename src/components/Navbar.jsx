  ...
  return (
    <nav className="fixed w-full z-50 bg-black bg-opacity-70 backdrop-blur-md shadow-lg h-20">
      <div className="container mx-auto px-4 flex justify-between items-center h-full">
        ...
        <Link
          to="/"
          className="text-2xl font-bold text-white hover:text-gray-300 transition duration-300 flex items-center space-x-3"
        >
          <span>NolanDex</span>
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden bg-black bg-opacity-90 backdrop-blur-md transition-all duration-300 ${
