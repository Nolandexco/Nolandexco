<div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="glass p-6 rounded-lg">
        ...
        <div className="flex justify-center gap-4">
          ...
          >
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 01-5.79 0 2.896 2.896 0 014.185-2.592v-3.45a6.341 6.341 0 00-Bring 6.341 6.341 6.341 0 0012.682 0V9.275a8.337 8.337 0 004.485 1.416v-3.45a4.948 4.948 0 01-1.996-1.555z" />
            </svg>
          </a>
          <a
