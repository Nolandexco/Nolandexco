    ...
    <section id="contact" className="min-h-screen flex items-center bg-gray-900 text-white opacity-70">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-gray-300 text-lg max-w-2xl mx-auto">
          Ready to launch your business or have questions? Contact NolanDex today!
        </p>
            ...
            <div className="flex justify-center gap-4">
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.326 3.608 1.301.975.975 1.24 2.242 1.301 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.326 2.633-1.301 3.608-.975.975-2.242 1.24-3.608 1.301-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.326-3.608-1.301-.975-.975-1.24-2.242-1.301-3.608-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.062-1.366.326-2.633 1.301-3.608.975-.975 2.242-1.24 3.608-1.301 1.266-.058 1.646-.07 4.85-.07m0-2.163c-3.259 0-3.667.014-4.947.072-1.425.065-2.888.365-4.123 1.6C1.695 2.907 1.395 4.37 1.33 5.795c-.058 1.28-.072 1.688-.072 4.947s.014 3.667.072 4.947c.065 1.425.365 2.888 1.6 4.123 1.235 1.235 2.698 1.535 4.123 1.6 1.28.058 1.688.072 4.947.072s3.667-.014 4.947-.072c1.425-.065 2.888-.365 4.123-1.6 1.235-1.235 1.535-2.698 1.6-4.123.058-1.28.072-1.688.072-4.947s-.014-3.667-.072-4.947c-.065-1.425-.365-2.888-1.6-4.123-1.235-1.235-2.698-1.535-4.123-1.6-1.28-.058-1.688-.072-4.947-.072z" />
              ...
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 01-5.79 0 2.896 2.896 0 014.185-2.592v-3.45a6.341 6.341 0 00-6.341 6.341 6.341 6.341 0 0012.682 0V9.275a8.337 8.337 0 004.485 1.416v-3.45a4.948 4.948 0 01-1.996-1.555z" />
                </svg>
              </a>
              <a
